...
source_archives = r"C:\MusShared\Podcasts\RadioFrance.Archives\L'humour d'inter"
...
folder_to_artist_crhonique = {
    ...
    "la-drole-d-humeur-de-rebecca-balestra": ("Rebecca Balestra", "La drôle d'humeur de Rebecca Balestra"),
