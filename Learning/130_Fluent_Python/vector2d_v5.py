# vector2d_v5
# Example 13-17
# Hints for conversion from/to complex
#
# 2023-08-07    PV
...
from __future__ import annotations     # To make pylance and ruff happy about Vector2D reference in fromcomplex
...
v = Vector2d(3, 4)
print('isinstance(v, SupportsComplex):',isinstance(v, SupportsComplex))
