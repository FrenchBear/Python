...
WINHEIGHT = 1024 # height in pixels
...
CAM_MOVE_SPEED = 3 # how many pixels per frame the camera moves
...
def startScreen():
    ...
    instructionText = ['Push the stars over the marks.',
                       'Arrow keys to move, QZSD for camera control, P to change character.',
