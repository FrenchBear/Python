...
#
# 2015-05-09    PV
# 2016-06-01    PV		Adjustment for Raspberri Pi (added main arguments)
...
if len(sys.argv)!=1 and len(sys.argv)!=2:
	print("Usage: python3 hil.py level")
	sys.exit()
...
if (len(sys.argv)==2):
	try:
		...
		print("hil: level must be an integer")
		sys.exit()

	if level<1 or level>10:
		print("hil: level must be in the range 1..10")
		sys.exit()
