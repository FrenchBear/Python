...
"""
Interfaces d=dict, dd=defaultdic, od=OrderedDict
                            d   dd  od
...
d.popitem()	                ●	●	● 	Remove and return an arbitrary (key, value) itemb
...
# defaultdic: when instantiating a defaultdict, you provide a callable that is
